            ...
            <ol className='mt-8 space-y-6'>
              <li className='space-y-2'>
                ...
                <div className='flex flex-wrap gap-2'>
                  ...
                  <ButtonLink href='https://github.com/theodorusclarence/next-ts-css-and-material-ui-boilerplate/blob/main/src/styles/colors.css'>
              ...
              <li className='space-y-2'>
                ...
                <div className='space-x-2'>
                  ...
                  <UnstyledLink href='https://plitzinc.com'>
                    Outside Links
                  </UnstyledLink>
                </div>
              </li>
              <li className='space-y-2'>
                ...
                <div className='space-x-2'>
                  ...
                  <PrimaryLink href='https://plitzinc.com'>
                    Outside Links
                  </PrimaryLink>
                </div>
              </li>
              <li className='space-y-2'>
                ...
                <div className='space-x-2'>
                  ...
                  <UnderlineLink href='https://plitzinc.com'>
                    Outside Links
                  </UnderlineLink>
                </div>
              </li>
              ...
              <li className='space-y-2'>
                ...
                <div className='flex flex-wrap gap-2'>
                  <ButtonLink variant='primary' href='https://plitzinc.com'>
                    Primary Variant
                  </ButtonLink>
                  <ButtonLink
                    variant='outline'
                    isDarkBg={mode === 'dark'}
                    href='https://plitzinc.com'
                  >
                    Outline Variant
                  </ButtonLink>
                  <ButtonLink
                  ...
                  <ButtonLink variant='dark' href='https://plitzinc.com'>
                    Dark Variant
                  </ButtonLink>
                  <ButtonLink variant='light' href='https://plitzinc.com'>
                    Light Variant
                  </ButtonLink>
                </div>
              </li>
